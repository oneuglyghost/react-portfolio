    ...
    <section>
      ...
      <div className="project">
          <div className="project-content">
            <img src="./public/images/project1.png" alt="Project 1" className="project-image" />
        ...
        <div className="project">
          <div className="project-content">
            <img src="./public/images/project2.png" alt="Project 2" className="project-image" />
            <div className="project-overlay">
        ...
        <div className="project">
          <div className="project-content">
            <img src="./public/images/project3.png" alt="Project 3" className="project-image" />
            <div className="project-overlay">
        ...
        <div className="project">
          <div className="project-content">
            <img src="./public/images/project4.png" alt="Project 4" className="project-image" />
            <div className="project-overlay">
        ...
        <div className="project">
          <div className="project-content">
            <img src="./public/images/project5.png" alt="Project 5" className="project-image" />
            <div className="project-overlay">
        ...
        <div className="project">
          <div className="project-content">
            <img src="./public/images/project6.png" alt="Project 6" className="project-image" />
            <div className="project-overlay">
